...
export default function Home({ navigation }) {
  ...
  const restorePurchases = async () => {
    try {
      ...
      // Check if the user has any active subscriptions after restoration
      if (
        customerInfo.activeSubscriptions &&
        customerInfo.activeSubscriptions.length > 0
      ) {
  ...
  const renderPaywallModal = () => {
    return (
      <Modal
        ...
        transparent
        animationType="none"
        onRequestClose={hidePaywallModal}
      >
        <View style={styles.paywallModalOverlay}>
          <Animated.View
            style={[
              styles.paywallModalContainer,
              {
                transform: [{ translateY: paywallSlideAnim }],
              },
            ]}
          >
            ...
            <View style={styles.paywallContent}>
              ...
              <View style={styles.featuresContainer}>
                ...
                <View style={styles.featureRow}>
                  <Ionicons name="checkmark-circle" size={24} color="#52C41A" />
                  <Text style={styles.featureText}>Advanced bet analysis</Text>
                </View>
                <View style={styles.featureRow}>
                  <Ionicons name="checkmark-circle" size={24} color="#52C41A" />
                  <Text style={styles.featureText}>
